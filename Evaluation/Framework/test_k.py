...
def test_twp_phase(start_filename, normal_ops_filename, rep_filename, key_length, save_init_filename, save_final_filename):
...
if __name__ == "__main__":
    ...
    if run_test:
        ...
        test_twp_phase(start_filename, normal_ops_filename, rep_filename, key_length, save_init_filename, save_final_filename)
